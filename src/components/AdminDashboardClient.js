                ...
                <div key={order.id} className="order-card" style={{ ...listCardStyle, opacity: order.status === 'CANCELLED' ? 0.6 : 1, flexWrap: 'wrap' }}>
                  ...
                  <div style={{ display: 'flex', gap: '8px', alignItems: 'center', flexWrap: 'wrap', flex: '1.5', minWidth: '280px', justifyContent: 'flex-end' }}>
                    ...
                    <div style={{ display: 'flex', gap: '8px', marginRight: 'auto' }}>
                      <button className="action-btn" onClick={() => triggerPrint(order.id)} style={{ ...btnPrimary, padding: '12px 20px', fontSize: '1.2rem', backgroundColor: theme.inputBg, color: theme.textPrimary, border: `1px solid ${theme.border}`, boxShadow: 'none' }}>
                        🖨️
                      </button>
                      ...
                      {order.customerPhone && (
                        <a 
                          ...
                          style={{ ...btnPrimary, padding: '12px 20px', backgroundColor: '#25D36615', color: '#25D366', border: '1px solid #25D36640', boxShadow: 'none', textDecoration: 'none', display: 'flex', alignItems: 'center' }}
                        >
